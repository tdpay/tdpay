 ...
 * </pre>
 */
@Mapper("withholdMapper")
public interface WithholdMapper {
	
	List<WithholdVO> selectWithholdList(WithHoldDefaultVO searchWithholdVO) throws IOException, SQLException;
	
	List<WithholdVO> selectCardList() throws IOException, SQLException;
}
