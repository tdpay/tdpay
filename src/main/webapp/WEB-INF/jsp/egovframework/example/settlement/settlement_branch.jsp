    ...
    <div class="inner">
        ...
        <div class="layout_wrap">
            <form name="" id="" method="get" action="" target="">
                ...
                <input type="hidden" name="role_id" id="role_id" value="1003">	<!-- 1002:영업대행, 1003:대리점, 1004:가맹점 -->
                ...
                <div class="btn_box">
                    <a href="javascript:settlement_branch_data();" class="dark_full_btn">내역조회</a> 
                    <a href="javascript:settlement_branch_init();" class="gray_line_btn">초기화</a>
                </div>
            </form>
        </div>
