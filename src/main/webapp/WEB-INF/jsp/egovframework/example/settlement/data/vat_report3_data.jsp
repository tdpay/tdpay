...
<%@ taglib prefix="ui"     uri="http://egovframework.gov/ctl/ui"%>   
                ...
                <form action="" class="table_layout02_wrap fixtable_wrap" name="frm4">
                    ...
                    <table class="table_layout02">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th><button type="button">상태</button></th>
                ...
                <div class="paging">
                    <ul class="pager_btn">
                        <ui:pagination paginationInfo = "${paginationInfo}" type="content" jsFunction="fn_link_page3"  />
                    </ul>
                </div>
                <!-- //pager -->
