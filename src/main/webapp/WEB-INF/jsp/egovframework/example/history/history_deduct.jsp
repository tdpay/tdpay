...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
    ...
    <script src="/js/history_deduct.js"></script>
    ...
    <div class="inner">
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="w180" placeholder="" name="dealing_yn" id="dealing_yn">
                                    <option value="">선택</option>
                                    <option value="Y" ${searchHistoryVO.dealing_yn eq 'Y' ?'selected':''}>입금완료</option>
                                    <option value="N" ${searchHistoryVO.dealing_yn eq 'N' ?'selected':''}>미입금</option>
                                </select>
                            </td>
                            <th>결제종류</th>
                            <td>
        ...
        <div class="layout_wrap" >
            ...
            <div id="">
                <form class="table_layout02_wrap" action="">
                    <table class="table_layout02">
                        <thead>
                            <tr>
                                ...
                                <th class="red_bg" colspan="3"><button type="button">차감완료금액(A)</button></th>
                            ...
                            <tr>
                                <th class="red_bg"><button type="button">수기입금ⓐ</button></th>
                                <th class="red_bg"><button type="button">정산차감ⓑ</button></th>
                                <th class="red_bg"><button type="button">A=ⓐ+ⓑ</button></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td><span></span></td>
                                <td class="red_bg"><span>100</span></td>
                                <td class="red_bg"><span>100</span></td>
                                <td class="red_bg"><span>100</span></td>
                                <td><span></span></td>
                                <td><span></span></td>
