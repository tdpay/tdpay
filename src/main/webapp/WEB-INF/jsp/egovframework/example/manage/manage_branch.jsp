...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
    ...
    <div class="inner">
        <div class="ttl_box">
            ...
            <a href="/manage/manage_branch_register.do" class="link_reg">대리점등록</a>
            </c:if>
        </div>
        <div class="layout_wrap">
            <form name="frm1" id="frm1" method="get" action="" target="">
                ...
                <table class="table_layout01">
                    ...
                    <tbody>
                            ...
                            <td colspan="3">
                                <div class="input_date">
                                    ...
                                    <div class="cal_select">
                                        <input type="text" id="start_datetime" name="start_datetime" class="width_150 date_form ui-datepicker-trigger" placeholder="" value="${searchManageVO.start_datetime }">
                                        <span class="tilde">~</span>
                                        <input type="text" id="end_datetime" name="end_datetime" class="width_150 date_form ui-datepicker-trigger" placeholder="" value="${searchManageVO.end_datetime }">
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <th>상점명</th>
                            <td>
                                <input class="w180" type="text" name="business_nm" placeholder="" id="business_nm" value="${searchManageVO.business_nm }">
                            </td>
                            <th>이메일</th>
                            <td>
                                <select class="w140" name="searchKeyword1" placeholder="" id="searchKeyword1">
                                ...
                                <input class="w180" type="email" name="email" placeholder="" id="email" value="${searchManageVO.email }">
                            </td>
                        </tr>
                        <tr>
                            <th>연락처</th>
                            <td>
                                <input class="w180" type="tel" name="tel" placeholder="" id="tel" value="${searchManageVO.tel }">
                            </td>
                            <th>휴대폰</th>
                            <td>
                                <select class="w140" name="searchKeyword2" placeholder="" id="searchKeyword2">
                                ...
                                <input class="w180" type="tel" name="phone_num" placeholder="" id="phone_num" value="${searchManageVO.phone_num }">
                            </td>
                        </tr>
                        <tr>
                            <th>영업대행</th>
                            <td>
                                <select class="w180" name="roleStore" placeholder="" id="roleStore">
                                    <option value="">전체</option>
                                </select>
                            </td>
                            <th>이름</th>
                            <td>
                                <select class="w140" name="searchKeyword" placeholder="" id="searchKeyword">
                                ...
                                <input class="w180" type="tel" name="person_nm" placeholder="" id="person_nm" value="${searchManageVO.person_nm }">
                            </td>
                        </tr>
                        <tr>
                            <th>상점ID</th>
                            <td>
                                <input class="w180" type="tel" name="store_id" placeholder="" id="store_id" value="${searchManageVO.store_id }">
                            </td>
                            <th>상태</th>
                            <td>
                        ...
                        <tr>
                            <th>수수료</th>
                            <td colspan="3">
                                <input class="w180" type="tel" name="commission" placeholder="" id="commission" value="${searchManageVO.commission }">
                ...
                <div class="btn_box">
                    <a href="javascript:manage_branch_data();" class="dark_full_btn">내역조회</a> 
                    <a href="javascript:manage_branch_init();" class="gray_line_btn">초기화</a>
                </div>
